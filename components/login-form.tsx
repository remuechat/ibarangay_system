...
import barangayPhoto from "@/public/barangayphoto.jpg"
  ...
  const [formValues, setFormValues] = useState({
    ...
    if (window.google) {
      window.google.accounts.id.initialize({
        client_id: 783219993432-gaap7gn9s8j8nbgg8dmukjqlhrijlj17.apps.googleusercontent.com,
        ux_mode: "redirect",
    ...
    const validateField = (field: string, value: string) => {
      try {
        loginSchema.safeParse({...formValues, [field]: value})
            ...
            <FieldGroup>
              ...
              <Field>
                ...
                <Input
                  id="email"
                  type="email"
                  placeholder="gwapoko123@gmail.com"
